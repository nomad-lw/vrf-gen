            ...
            ) -> alloy_sol_types::Result<OwnableRolesErrors>] = &[
                {
                    fn AlreadyInitialized(
                        ...
                        <AlreadyInitialized as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(OwnableRolesErrors::AlreadyInitialized)
                    }
                    AlreadyInitialized
                },
                {
...
See the [wrapper's documentation](`OwnableRolesInstance`) for more details.*/
    ...
    >(
        ...
        provider: P,
    ) -> OwnableRolesInstance<T, P, N> {
        OwnableRolesInstance::<T, P, N>::new(address, provider)
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
    ...
    >(
        ...
        Output = alloy_contract::Result<OwnableRolesInstance<T, P, N>>,
    > {
        OwnableRolesInstance::<T, P, N>::deploy(provider)
    }
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    >(provider: P) -> alloy_contract::RawCallBuilder<T, P, N> {
        OwnableRolesInstance::<T, P, N>::deploy_builder(provider)
    }
...
See the [module-level documentation](self) for all the available methods.*/
    #[derive(Clone)]
    pub struct OwnableRolesInstance<T, P, N = alloy_contract::private::Ethereum> {
        address: alloy_sol_types::private::Address,
        provider: P,
        _network_transport: ::core::marker::PhantomData<(N, T)>,
    }
    #[automatically_derived]
    impl<T, P, N> ::core::fmt::Debug for OwnableRolesInstance<T, P, N> {
        #[inline]
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
        ...
        pub async fn deploy(
            provider: P,
        ) -> alloy_contract::Result<OwnableRolesInstance<T, P, N>> {
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    impl<T, P: ::core::clone::Clone, N> OwnableRolesInstance<T, &P, N> {
        /// Clones the provider and returns a new instance with the cloned provider.
        #[inline]
        pub fn with_cloned_provider(self) -> OwnableRolesInstance<T, P, N> {
