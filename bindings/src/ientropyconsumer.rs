...
```*/
    ...
    ///Container for all the [`IEntropyConsumer`](self) function calls.
    pub enum IEntropyConsumerCalls {
        #[allow(missing_docs)]
        _entropyCallback(_entropyCallbackCall),
    }
    #[automatically_derived]
    impl IEntropyConsumerCalls {
        ...
        pub const SELECTORS: &'static [[u8; 4usize]] = &[[82u8, 165u8, 241u8, 248u8]];
    }
    #[automatically_derived]
    impl alloy_sol_types::SolInterface for IEntropyConsumerCalls {
        const NAME: &'static str = "IEntropyConsumerCalls";
        ...
        fn abi_decode_raw(
            ...
            static DECODE_SHIMS: &[fn(
                &[u8],
                bool,
            ) -> alloy_sol_types::Result<IEntropyConsumerCalls>] = &[
                {
                    fn _entropyCallback(
                        data: &[u8],
                        validate: bool,
                        ...
                        <_entropyCallbackCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IEntropyConsumerCalls::_entropyCallback)
                    }
                    _entropyCallback
                },
            ];
    ...
    /**Creates a new wrapper around an on-chain [`IEntropyConsumer`](self) contract instance.

See the [wrapper's documentation](`IEntropyConsumerInstance`) for more details.*/
    #[inline]
    pub const fn new<
    ...
    >(
        ...
        provider: P,
    ) -> IEntropyConsumerInstance<T, P, N> {
        IEntropyConsumerInstance::<T, P, N>::new(address, provider)
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
    ...
    >(
        ...
        Output = alloy_contract::Result<IEntropyConsumerInstance<T, P, N>>,
    > {
        IEntropyConsumerInstance::<T, P, N>::deploy(provider)
    }
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    >(provider: P) -> alloy_contract::RawCallBuilder<T, P, N> {
        IEntropyConsumerInstance::<T, P, N>::deploy_builder(provider)
    }
    /**A [`IEntropyConsumer`](self) instance.

Contains type-safe methods for interacting with an on-chain instance of the
[`IEntropyConsumer`](self) contract located at a given `address`, using a given
provider `P`.
...
See the [module-level documentation](self) for all the available methods.*/
    #[derive(Clone)]
    pub struct IEntropyConsumerInstance<T, P, N = alloy_contract::private::Ethereum> {
        address: alloy_sol_types::private::Address,
        provider: P,
        _network_transport: ::core::marker::PhantomData<(N, T)>,
    }
    #[automatically_derived]
    impl<T, P, N> ::core::fmt::Debug for IEntropyConsumerInstance<T, P, N> {
        #[inline]
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple("IEntropyConsumerInstance").field(&self.address).finish()
        }
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
        ...
        pub async fn deploy(
            provider: P,
        ) -> alloy_contract::Result<IEntropyConsumerInstance<T, P, N>> {
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    impl<T, P: ::core::clone::Clone, N> IEntropyConsumerInstance<T, &P, N> {
        /// Clones the provider and returns a new instance with the cloned provider.
        #[inline]
        pub fn with_cloned_provider(self) -> IEntropyConsumerInstance<T, P, N> {
            IEntropyConsumerInstance {
