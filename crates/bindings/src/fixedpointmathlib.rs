...
pub mod FixedPointMathLib {
    ...
    ///
    /// ```text
    ///0x60808060405234601757603a9081601d823930815050f35b600080fdfe600080fdfea2646970667358221220adde1d924f15a1dc58f2d655d95cd9593f6916752313f013ba40cc16574c879c64736f6c634300081c0033
    /// ```
    #[rustfmt::skip]
    #[allow(clippy::all)]
    pub static BYTECODE: alloy_sol_types::private::Bytes = alloy_sol_types::private::Bytes::from_static(
        b"`\x80\x80`@R4`\x17W`:\x90\x81`\x1D\x8290\x81PP\xF3[`\0\x80\xFD\xFE`\0\x80\xFD\xFE\xA2dipfsX\"\x12 \xAD\xDE\x1D\x92O\x15\xA1\xDCX\xF2\xD6U\xD9\\\xD9Y?i\x16u#\x13\xF0\x13\xBA@\xCC\x16WL\x87\x9CdsolcC\0\x08\x1C\x003",
    );
    /// The runtime bytecode of the contract, as deployed on the network.
    ///
    /// ```text
    ///0x600080fdfea2646970667358221220adde1d924f15a1dc58f2d655d95cd9593f6916752313f013ba40cc16574c879c64736f6c634300081c0033
    /// ```
    #[rustfmt::skip]
    #[allow(clippy::all)]
    pub static DEPLOYED_BYTECODE: alloy_sol_types::private::Bytes = alloy_sol_types::private::Bytes::from_static(
        b"`\0\x80\xFD\xFE\xA2dipfsX\"\x12 \xAD\xDE\x1D\x92O\x15\xA1\xDCX\xF2\xD6U\xD9\\\xD9Y?i\x16u#\x13\xF0\x13\xBA@\xCC\x16WL\x87\x9CdsolcC\0\x08\x1C\x003",
    );
