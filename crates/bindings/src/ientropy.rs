...
```*/
    ...
    ///Container for all the [`IEntropy`](self) function calls.
    pub enum IEntropyCalls {
        #[allow(missing_docs)]
    ...
    #[automatically_derived]
    impl alloy_sol_types::SolInterface for IEntropyCalls {
        const NAME: &'static str = "IEntropyCalls";
        ...
        fn abi_decode_raw(
            ...
            static DECODE_SHIMS: &[fn(
                &[u8],
                bool,
            ) -> alloy_sol_types::Result<IEntropyCalls>] = &[
                {
                    fn withdraw(
                        data: &[u8],
                        validate: bool,
                ...
                },
                {
                    fn combineRandomValues(
                        ...
                        <combineRandomValuesCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IEntropyCalls::combineRandomValues)
                    }
                    combineRandomValues
                },
                {
                    fn requestWithCallback(
                        ...
                        <requestWithCallbackCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IEntropyCalls::requestWithCallback)
                    }
                    requestWithCallback
                },
                {
                    fn withdrawAsFeeManager(
                        ...
                        <withdrawAsFeeManagerCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IEntropyCalls::withdrawAsFeeManager)
                    }
                ...
                },
                {
                    fn revealWithCallback(
                        ...
                        <revealWithCallbackCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IEntropyCalls::revealWithCallback)
                    }
                    revealWithCallback
                },
                {
                    fn setFeeManager(
                        ...
                        <setFeeManagerCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IEntropyCalls::setFeeManager)
                    }
                    setFeeManager
                },
                {
                ...
                },
                {
                    fn getProviderInfo(
                        ...
                        <getProviderInfoCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IEntropyCalls::getProviderInfo)
                    }
                    getProviderInfo
                },
                {
                    fn getDefaultProvider(
                        ...
                        <getDefaultProviderCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IEntropyCalls::getDefaultProvider)
                    }
                    getDefaultProvider
                },
                {
                ...
                },
                {
                    fn setProviderFee(
                        ...
                        <setProviderFeeCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IEntropyCalls::setProviderFee)
                    }
                    setProviderFee
                },
                {
                    fn setProviderUri(
                        ...
                        <setProviderUriCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IEntropyCalls::setProviderUri)
                    }
                    setProviderUri
                },
                {
                ...
                },
                {
                    fn setProviderFeeAsFeeManager(
                        ...
                        <setProviderFeeAsFeeManagerCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IEntropyCalls::setProviderFeeAsFeeManager)
                    }
                ...
                },
                {
                    fn constructUserCommitment(
                        ...
                        <constructUserCommitmentCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IEntropyCalls::constructUserCommitment)
                    }
                ...
                },
                {
                    fn getAccruedPythFees(
                        ...
                        <getAccruedPythFeesCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IEntropyCalls::getAccruedPythFees)
                    }
                    getAccruedPythFees
                },
            ];
    ...
    ///Container for all the [`IEntropy`](self) events.
    pub enum IEntropyEvents {
        #[allow(missing_docs)]
    ...
    #[automatically_derived]
    impl alloy_sol_types::SolEventInterface for IEntropyEvents {
        const NAME: &'static str = "IEntropyEvents";
    ...
    #[automatically_derived]
    impl alloy_sol_types::private::IntoLogData for IEntropyEvents {
        fn to_log_data(&self) -> alloy_sol_types::private::LogData {
            match self {
    ...
    use alloy::contract as alloy_contract;
    /**Creates a new wrapper around an on-chain [`IEntropy`](self) contract instance.

See the [wrapper's documentation](`IEntropyInstance`) for more details.*/
    #[inline]
    pub const fn new<
        T: alloy_contract::private::Transport + ::core::clone::Clone,
        P: alloy_contract::private::Provider<T, N>,
    ...
    >(
        address: alloy_sol_types::private::Address,
        provider: P,
    ) -> IEntropyInstance<T, P, N> {
        IEntropyInstance::<T, P, N>::new(address, provider)
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
    ...
    >(
        ...
        Output = alloy_contract::Result<IEntropyInstance<T, P, N>>,
    > {
        IEntropyInstance::<T, P, N>::deploy(provider)
    }
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    >(provider: P) -> alloy_contract::RawCallBuilder<T, P, N> {
        IEntropyInstance::<T, P, N>::deploy_builder(provider)
    }
    /**A [`IEntropy`](self) instance.

Contains type-safe methods for interacting with an on-chain instance of the
[`IEntropy`](self) contract located at a given `address`, using a given
provider `P`.
...
See the [module-level documentation](self) for all the available methods.*/
    #[derive(Clone)]
    pub struct IEntropyInstance<T, P, N = alloy_contract::private::Ethereum> {
        address: alloy_sol_types::private::Address,
        provider: P,
        _network_transport: ::core::marker::PhantomData<(N, T)>,
    }
    #[automatically_derived]
    impl<T, P, N> ::core::fmt::Debug for IEntropyInstance<T, P, N> {
        #[inline]
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple("IEntropyInstance").field(&self.address).finish()
        }
    }
    /// Instantiation and getters/setters.
    #[automatically_derived]
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
        ...
        pub async fn deploy(
            provider: P,
        ) -> alloy_contract::Result<IEntropyInstance<T, P, N>> {
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    impl<T, P: ::core::clone::Clone, N> IEntropyInstance<T, &P, N> {
        /// Clones the provider and returns a new instance with the cloned provider.
        #[inline]
        pub fn with_cloned_provider(self) -> IEntropyInstance<T, P, N> {
            IEntropyInstance {
                address: self.address,
                provider: ::core::clone::Clone::clone(&self.provider),
                _network_transport: ::core::marker::PhantomData,
